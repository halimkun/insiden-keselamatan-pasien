                                    ...
                                    <dl class="divide-y divide-gray-100">
                                        ...
                                        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            ...
                                            <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                                <kbd class="rounded-md bg-black px-1.5 py-0.5 leading-none tracking-wider text-white">{{ $pasien->nik }}</kbd>
                                            </dd>
                                        </div>
                                        ...
                                        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            ...
                                            <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $pasien->no_telepon }}</dd>
                                        </div>

                                        <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt class="text-sm font-medium leading-6 text-gray-900">Email</dt>
                                            <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                                <a href="mailto:{{ $pasien->email }}" class="hover:underline">{{ $pasien->email }}</a>
                                            </dd>
                                        </div>
