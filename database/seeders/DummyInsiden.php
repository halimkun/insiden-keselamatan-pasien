    ...
    public function run(): void
    {
        ...
        foreach ($data as $item) {
            ...
            $insiden = \App\Models\Insiden::create([
                ...
                "tanggal_insiden"         => $faker->dateTimeBetween($masukPasie, $faker->dateTimeBetween($masukPasie, '+5 days'))->format('Y-m-d'),
                ...
                "layanan_insiden"         => $faker->randomElement(['ranap', 'ralan', 'udg']),
                ...
                "dampak_insiden"          => $item['jenis_insiden_alias'] == 'SENTINEL' ? 'mayor' : $faker->randomElement(['minor', 'moderate']),
