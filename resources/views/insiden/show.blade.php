        ...
        <div class="w-full">
            <header class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Detail insiden {{
                        $insiden->tanggal_insiden?->translatedFormat('l, j F Y') }}</p>
                </div>
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a type="button" href="{{ route('insiden.index') }}"
                    ...
                    <div class="w-full">
                            ...
                            <dl class="divide-y divide-gray-100">
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-xs leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <kbd
                                            class="rounded-md bg-black px-1.5 py-0.5 leading-none tracking-wider text-white">{{
                                            $insiden->pasien->nik }}</kbd>
                                    </dd>
                                </div>
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-xs leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <kbd
                                            class="rounded-md bg-black px-1.5 py-0.5 leading-none tracking-wider text-white">{{
                                            $insiden->pasien->no_rekam_medis }}</kbd>
                                    </dd>
                                </div>
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{
                                        $insiden->pasien->tempat_lahir }}</dd>
                                </div>
                                ...
                                <div class="items-start px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        ...
                                        <p class="text-[0.8rem] font-semibold leading-none">{{
                                            $insiden->pasien->tanggal_lahir->diff(\Carbon\Carbon::now())->format('%y
                                            Tahun %m Bulan %d Hari') }}</p>
                                    </dd>
                                </div>
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{
                                        $insiden->pasien->no_telp }}</dd>
                                </div>

                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">Email</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <a href="mailto:{{ $insiden->pasien->email }}" class="hover:underline">{{
                                            $insiden->pasien->email }}</a>
                                    </dd>
                                </div>
                        ...
                        <div class="mt-3 mb-5">
                            <dl class="divide-y divide-gray-200">
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">Insiden Yang
                                        Terjadi</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->insiden }}</dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">Waktu Insiden
                                    </dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">Jenis Insiden
                                    </dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->jenis->nama_jenis_insiden }} ({{ $insiden->jenis->alias }})</dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">Dampak Insiden
                                        Terhadap Pasien</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->dampak_insiden }}</dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">
                                        {{ $insiden->jenis_pelapor == 'lainnya' ? $insiden->jenis_pelapor_lainnya :
                                        $insiden->jenis_pelapor }}
                                    </dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">
                                        {{ $insiden->korban_insiden == 'lainnya' ? $insiden->korban_insiden_lainnya :
                                        $insiden->korban_insiden }}
                                    </dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">Tempat Kejadian
                                    </dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->tempat_kejadian }}</dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->unit->nama_unit }}</dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900 capitalize">Kronologi
                                        Kejadian</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->kronologi }}</dd>
                                </div>
                        ...
                        <div class="mt-3 mb-5">
                            <dl class="divide-y divide-gray-100">
                                ...
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">Pernah Terjadi di Unit Lain
                                    </dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->pernah_terjadi ? 'Ya' : 'Tidak' }}</dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">Status Pelapor</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 capitalize">{{
                                        $insiden->status_pelapor }}</dd>
                                </div>
                                <div class="px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
