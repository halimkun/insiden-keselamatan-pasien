        ...
        <div class="w-full">
            <header class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h2 class="text-lg font-semibold text-gray-900">Tambah Unit Kerja Baru</h2>
                    <p class="mt-1 text-sm text-gray-600">Tambah data unit kerja rumah sakit.</p>
                </div>
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a type="button" href="{{ route('unit.index') }}"
            ...
            <div class="flow-root">
                <div class="mt-8">
                    <div class="max-w-xl py-2 align-middle">
                        <form method="POST" action="{{ route('unit.store') }}" role="form"
