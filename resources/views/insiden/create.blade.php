        ...
        <div class="bg-white p-4 shadow sm:rounded-lg sm:p-8">
            <div class="w-full">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="investigasi_sederhana" id="investigasi_sederhana" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" placeholder="investigasi_sederhana sederhana">{{ old('investigasi_sederhana', $insiden?->investigasi_sederhana) }}</textarea>
