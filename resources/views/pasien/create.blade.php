        ...
        <div class="w-full">
            <header class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h2 class="text-lg font-semibold text-gray-900">Tambah Pasien</h2>
                    <p class="mt-1 text-sm text-gray-600">Tambah data pasien baru</p>
                </div>
            ...
            <div class="flow-root">
                <div class="mt-8">
                    <div class="w-full py-2 align-middle">
                        <form method="POST" action="{{ route('pasien.store') }}" role="form"
