<x-app-layout>
    @push('styles')
        ...
        <style>
            .dt-search { display: none; visibility: hidden; }
        </style>
    @endpush
                        ...
                        <div class="mt-8 overflow-x-visible">
                            <div class="inline-block min-w-full py-2 align-middle">
                                ...
                                <div class="flex items-center space-x-2">
                                    <label for="show_deleted" class="text-base text-gray-700">Show Deleted</label>
                                    <input type="checkbox" id="show_deleted" class="checkbox checkbox-sm" />
                                </div>
    ...
    <dialog id="confirmDelete" class="modal">
        <div class="modal-box">
            <form method="POST">
                ...
                <div class="modal-action mt-4 flex justify-end space-x-4">
            ...
            $(document).ready(function() {
                ...
                var table = $('#tableData').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'email', name: 'email', render: (data) => `<a href="mailto:${data}" class="hover:underline">${data}</a>` },
