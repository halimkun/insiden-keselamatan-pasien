        ...
        <div class="w-full">
            <header class="sm:flex sm:items-center">
                ...
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a type="button" href="{{ route('pasien.index') }}"
                        ...
                        <div class="mt-6 border-t border-gray-100">
                            <dl class="divide-y divide-gray-100">
                                ...
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        {{ $pasien->penanggungBiaya->jenis_penanggung }}
                                    </dd>
                                </div>

                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    <dt class="text-sm font-medium leading-6 text-gray-900">Tempat Lahir</dt>
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ $pasien->tempat_lahir }}</dd>
                                </div>
                                ...
                                <div class="items-start px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        ...
                                        <p class="text-[0.8rem] font-semibold leading-none">{{
                                            $pasien->tanggal_lahir->diff(\Carbon\Carbon::now())->format('%y Tahun %m
                                            Bulan %d Hari') }}</p>
                                    </dd>
                                </div>
                                ...
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <a href="mailto:{{ $pasien->email }}" class="hover:underline">{{ $pasien->email
                                            }}</a>
                                    </dd>
                                </div>
