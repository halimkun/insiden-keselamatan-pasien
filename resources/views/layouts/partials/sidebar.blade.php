<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5">
        ...
        <img src="{{ asset(\App\Helpers\SettingHelper::get('site_logo', 'images/logo.png' )) }}" alt="Logo" class="w-[200px]" />
        @else
        ...
        <nav class="px-4 py-4 lg:px-6">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <!-- Menu Item Jabatan -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ request()->routeIs('jabatan.index') ? 'bg-graydark dark:bg-meta-4' : '' }}"
                            href="{{ route('jabatan.index') }}">
                            <x-icons.user-shield class="h-6 w-6" />
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ request()->routeIs('penanggung-biaya.index') ? 'bg-graydark dark:bg-meta-4' : '' }}"
                            ...
                            <x-icons.moneybag class="h-5 w-5" />
