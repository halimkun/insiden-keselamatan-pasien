        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-indigo-500 shadow-lg shadow-indigo-400 rounded-xl">
                <div class="flex flex-col-reverse md:flex-row items-start md:items-center md:justify-between gap-6 p-6">
                    ...
                    <div
                        class="p-10 bg-indigo-50 flex items-center justify-center rounded-xl hover:bg-indigo-100 transition-all duration-300 ease-in-out group">
                        <x-icons.database-star
                            class="h-[2rem] w-[2rem] text-amber-500 group-hover:scale-110 transition-all duration-300 ease-in-out" />
                    </div>
                </div>
            </div>
        </div>
